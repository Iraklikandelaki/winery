...
var camera = new THREE.PerspectiveCamera( 19, document.querySelector(".canvas1-parent").clientWidth/document.querySelector(".canvas1-parent").clientHeight, 1, 5000 );
...
// scene.add( ambLight );
    ...
    gltfLoader.load('./bottle1/scene.gltf', (gltf) => {
      root = gltf.scene;
	//   root.scale.set(2, 2, 2) // scale here
	  root.position.set(2253, -250, 493)
...
camera.position.set( -1400, 690, 1240 );

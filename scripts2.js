var example1 = function(){
	...
	var camera = new THREE.PerspectiveCamera( 5, document.querySelector(".canvas2-parent").clientWidth/document.querySelector(".canvas2-parent").clientHeight, 1, 2000 );
...
scene.add( ambLight );
		...
		gltfLoader.load('./wine_flask/scene.gltf', (gltf) => {
	...
	function onMouseMove( event ) {
		...
		function clickToLink(){
			...
			// 	document.querySelector("#canvas3").style.display = "block";

			// }, 1050);

			// setTimeout(() => {
			// 	document.querySelector("#canvas3").style.opacity = "1";
			// }, 1055);
		}
